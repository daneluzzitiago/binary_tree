...
No* cria_No(){
	...
	aux->portEnt = (char*)malloc(sizeof(char)*3);
	return aux;
}
...
////////////////////////////////////////////////////////////////////////////////////////// MUDAR ESTA PORRA PORQUE TA ERRADO////////////////
int insere_ElemenNO(ArvBin *raiz, char* pE) //insere porta/Entrada
{
    if(raiz == NULL)
        return 0;
    struct NO* novo;
    ...
    else
    {
        ...
        {
            ant = atual;
            if(strcmp(pE, atual->portEnt) == 0 /*pE == atual->portEnt*/)
            {
                free(novo);
                return 0;
            }
        ...
        //if(strcmp(pE, ant->portEnt) > 0 /*pE > ant->portEnt*/)
            //ant->dir = novo;
        //else
            //ant->esq = novo;
    }
